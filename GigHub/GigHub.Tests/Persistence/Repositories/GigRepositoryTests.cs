...
namespace GigHub.Tests.Persistence.Repositories
{
    ...
    public class GigRepositoryTests
    {
        ...
        public void GetUpcomingGigsByArtist_GigIsForADifferentArtist_ShouldNotBeReturned()
        {
            ...
            var gigs = _repository.GetUpcomingGigsByArtist(gig.ArtistId + "Bob");
        ...
        [TestMethod]
        public void GetGigsUserAttending_AttendeeIsNotUser_ShouldNotBeReturned()
        {
            ...
            var gigs = _repository.GetGigsUserAttending(attendance.AttendeeId + "jangles");

            gigs.Should().BeEmpty();
        }

        [TestMethod]
        public void GetGigsUserAttending_GigIsInPast_ShouldNotBeReturned()
        {
            var gig = new Gig { DateTime = DateTime.Now.AddDays(-1) };
            var attendance = new Attendance { Gig = gig, AttendeeId = "1" };
        ...
        [TestMethod]
        public void GetGigsUserAttending_GigIsInFutureAndAttendeeIsUser_ShouldBeReturned()
        {
            var gig = new Gig { DateTime = DateTime.Now.AddDays(1) };
            var attendance = new Attendance { Gig = gig, AttendeeId = "1" };
